  ...
  return (
    <View>
      ...
      <View className='p-[25px] bg-green-1 h-full flex items-center -mt-1 rounded-xl'>
        ...
        <Text className='text-xl font-semibold mt-10 text-white text-center font-popSb'>Track your medication, take control of your health. Stay Consistent. Stay Ready. Gotta stay in the cold!</Text>
        <TouchableOpacity
